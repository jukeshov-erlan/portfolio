...
const Hero = ({ hasAnimated }) => {
  {
    /* hasAnimated -> useIntersectionObserver */
  }
  ...
  {
    /* ["Frontend Developer", "React Specialist", "Creative Coder"] */
  }
  ...
  return (
    <section className="relative h-screen flex items-center justify-center overflow-hidden bg-linear-to-br from-white via-gray-50 to-gray-100 pt-20">
      ...
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute -top-4 -right-40 w-80 h-80 bg-linear-to-br from-blue-400 to-purple-600 rounded-full opacity-10 blur-3xl animate-pulse"></div>
      ...
      {/*Grid pattern*/}
      <div className="absolute inset-0 bg-[linear-gradient(rgba(0, 0, 0, 0.2)_1px, transparent_1px), linear-gradient(90deg, rgba(0, 0, 0, 0.2)_1px, transparent_1px)] bg-[size:50px_50px]"></div>
      <div className="relative z-10 max-w-6xl mx-auto px-6 text-center h-full flex flex-col justify-center">
        ...
        >
          {/* Greeting */}
          <div className="mb-4">
            <span className="inline-block px-4 py-2 leading-tight bg-black text-white rounded-full text-sm font-medium animate-fade-in">
              {heroData.greeting}
            </span>
          </div>
          {/* Name */}
          <h1 className="text-5xl md:text-7xl font-bold mb-4 bg-linear-to-br from-black via-gray-800 to-gray-600 bg-clip-text text-transparent animate-fade-in-up">
            {heroData.name}
          </h1>
          {/* TypewriterRole */}
          <div className="h-12 md:h-16 mb-6 flex items-center justify-center">
            <h2 className="text-2xl md:text-4xl font-semibold to-gray-700">
              I'm a{" "}
